...
// 판매 리스트 표시
		...
		/*} else if (s.equalsIgnoreCase("sco")) { // UB관련 「고득점자 일람을 확인한다」
			...
			if (pc.getLevel() < 2){ htmlid = ""
				; pc.setExp(pc.getExp() + 125);} // 경험치 지급
			else if (pc.getLevel() < 4){ 
				htmlid = "tutorm1";} // 허수아비 안내
			else if (pc.getLevel() < 5) { 
				htmlid = "tutorm2";} // 1단계 마법
			else if (pc.getLevel() < 8) { 
				htmlid = "tutorm3";} // 창고 ㅋ
			else if (pc.getLevel() < 12) { 
				htmlid = "tutorm4";} // 2단계 마법
			else if (pc.getLevel() < 13) { 
				htmlid = "tutorm5";} // 3단계 마법
			else if (pc.getLevel() < 14) { 
				htmlid = "tutorm6";} // 배울게 없대 ㅋ
			...
			pc.sendPackets(new S_MPUpdate(pc.getCurrentMp(), pc.getMaxMp()));
			if (pc.getLevel() < 2){
			 htmlid = "tutor"; pc.setExp(pc.getExp() + 125);} // 경험치 지급
			else if (pc.getLevel() < 5){ htmlid = "tutorp1";} // 허수아비 안내
			else if (pc.getLevel() < 7) { htmlid = "tutorp2";} // 창고/ 혈맹창설 ㅋ
			else if (pc.getLevel() < 10) { htmlid = "tutorp3";} // 칭찬질 --ㅋ
			else if (pc.getLevel() < 13) { htmlid = "tutorp4";} // 1단계 일반마법
			else if (pc.getLevel() < 14) { htmlid = "tutorp5";} // 배울게없대 ㅋ
			...
			pc.sendPackets(new S_MPUpdate(pc.getCurrentMp(), pc.getMaxMp()));
			if (pc.getLevel() < 2){
			 htmlid = ""; pc.setExp(pc.getExp() + 125);} // 경험치 지급
			else if (pc.getLevel() < 5){
			 htmlid = "tutore1";} // 허수아비 안내
			else if (pc.getLevel() < 8) {
			 htmlid = "tutore2";} // 창고
			else if (pc.getLevel() < 9) {
			 htmlid = "tutore3";} // 1단계 일반마법
			else if (pc.getLevel() < 10) {
			 htmlid = "tutore4";} // 그냥 칭찬질 --ㅋ
			else if (pc.getLevel() < 11) {
			 htmlid = "tutore5";} // 1단계 요정마법
			else if (pc.getLevel() < 14) {
			 htmlid = "tutore6";} // 배울게 없대 
			...
			pc.setExp(pc.getExp() + 125);} // 경험치 지급
			 ...
			 htmlid = "tutord1";} // 허수아비 안내
			else if (pc.getLevel() < 6) {
			 htmlid = "tutord2";} // 창고
			else if (pc.getLevel() < 8) {
			 htmlid = "tutord3";} // 그냥 칭찬질 --ㅋ
			else if (pc.getLevel() < 10) {
			 htmlid = "tutord4";} // 그냥 칭찬질 --ㅋ
			else if (pc.getLevel() < 13) {
			 htmlid = "tutord5";} // 1단계 일반마법
			else if (pc.getLevel() < 14) {
			 htmlid = "tutord6";} // 배울게 없대 ㅋ
			...
			if (pc.getLevel() < 2){
			 ...
			 htmlid = "tutori1";} // 허수아비 안내
			else if (pc.getLevel() < 6) {
			 htmlid = "tutori2";} // 창고
			else if (pc.getLevel() < 10) {
			 htmlid = "tutori3";} // 그냥 칭찬질 --ㅋ
			else if (pc.getLevel() < 12) {
			 htmlid = "tutori4";} // 환술사 1단계마법
			else if (pc.getLevel() < 14) {
			 htmlid = "tutori5";} // 배울게없대 ㅋ
			...
			pc.setExp(pc.getExp() + 125);} // 경험치 지급
			 ...
			 htmlid = "tutordk1";} // 허수아비 안내
			else if (pc.getLevel() < 6) {
			 htmlid = "tutordk2";} // 창고
			else if (pc.getLevel() < 8) {
			 htmlid = "tutordk3";} // 그냥 칭찬질 --ㅋ
			else if (pc.getLevel() < 10) {
			 htmlid = "tutordk4";} // 그냥 칭찬질 --ㅋ
			else if (pc.getLevel() < 14) {
			 htmlid = "tutordk5";} // 마냥 칭찬질 --ㅋ
