...
public class Account {
     ...
     * 패스워드를 암호화한다.
     *
     * @param rawPassword 평문의 패스워드
     * @return String
     * @throws NoSuchAlgorithmException     암호 알고리즘을 사용할 수 없는 환경때
     * @throws UnsupportedEncodingException 문자의 encode가 서포트되어 있지 않을 때
     */
     ...
     *
     * @param name        어카운트명
     * @param rawPassword 평문패스워드
     * @param ip          접속처의 IP주소
     * @param host        접속처의 호스트명
     * @return Account
     */
