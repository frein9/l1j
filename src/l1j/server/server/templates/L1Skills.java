...
public class L1Skills {
	...
	private int _reuseDelay; // 단위：밀리 세컨드
	...
	private int _buffDuration; // 단위：초
	...
	/**
	 * 스킬의 속성을 돌려준다.<br>
	 * 0.무속성 마법, 1.땅마법, 2.불마법, 4.수해법, 8.바람 마법, 16.광마법
	 */
	public int getAttr() {
		return _attr;
	}
	...
	private int _type; // 타입

	/**
	 * 스킬의 작용의 종류를 돌려준다.<br>
	 * 1.확률계, 2.엔챤트, 4.저주해, 8.죽음, 16.치료, 32.부활, 64.공격, 128.그 외 특수
	 */
	public int getType() {
		return _type;
	}
