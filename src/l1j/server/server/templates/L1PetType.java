...
public class L1PetType {
    ...
    private final int _npcIdForGolding;  // 승자의 열매
    ...
    public L1PetType(int baseNpcId, String name, int itemIdForTaming,
                     IntRange hpUpRange, IntRange mpUpRange, int npcIdForEvolving, int npcIdForGolding,
        ...
        _npcIdForGolding = npcIdForGolding;
        _msgIds = msgIds;
    ...
    public int getNpcIdForGolding() {
        return _npcIdForGolding;
    }

    public boolean canGold() {
        return _npcIdForGolding != 0;
    }
