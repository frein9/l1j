...
public class L1Object implements Serializable {
	...
	/**
	 * 오브젝트가 존재하는 맵을 보관 유지하는 L1Map 오브젝트를 돌려준다
	 * 
	 */
	public L1Map getMap() {
		return _loc.getMap();
	 ...
	 * 
	 * @param map
	 *            오브젝트가 존재하는 맵을 보관 유지하는 L1Map 오브젝트
	 */
