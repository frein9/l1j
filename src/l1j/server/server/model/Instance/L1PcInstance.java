...
/*	public boolean isBlood() {
    ...
    public int get_autoct() {
        return _autoct;
    } //by사부 오토인증추가

    public void set_autoct(int i) {
        _autoct = i;
    }

    public int get_autogo() {
        return _autogo;
    } //by사부 오토인증추가

    public void set_autogo(int i) {
        _autogo = i;
    }

    public String get_autocode() {
        return _autocode;
    } //by사부 오토인증추가

    public void set_autocode(String s) {
        _autocode = s;
    }

    public int get_autook() {
        return _autook;
    } //by사부 오토인증추가

    public void set_autook(int i) {
        _autook = i;
    }
     ...
     *
     * @param playersList 통지하는 플레이어의 배열
     */
...
*/
   ...
   /*    public boolean isSkillDelay() {
     ...
     * 플레이어의 최종 PK시간을 설정한다.
     *
     * @param time 최종 PK시간(Timestamp형) 해제하는 경우는 null를 대입
     */
