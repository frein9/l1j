...
import l1j.server.server.serverpackets.S_Ranking; // 랭킹 게시판
import l1j.server.server.serverpackets.S_Ranking2; // 용기사 환술사 랭킹 게시판
import l1j.server.server.serverpackets.S_EnchantRanking; // 인챈랭킹 게시판
