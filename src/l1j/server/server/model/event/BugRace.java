...
public class BugRace extends Thread {
    ...
    public void 레이스표(int id, int j) {
        ...
        switch (j) {
            case 0:
                if (대박 == 0) item.set_배율(((리틀버그베어[j].getRnd().nextInt(60) + 25) / 승률1_0));
                else item.set_배율(((리틀버그베어[j].getRnd().nextInt(55) + 15) / 승률1_0));
                break;
            case 1:
                if (대박 == 1) item.set_배율(((리틀버그베어[j].getRnd().nextInt(60) + 20) / 승률1_1));
                else item.set_배율(((리틀버그베어[j].getRnd().nextInt(55) + 10) / 승률1_1));
                break;
            case 2:
                if (대박 == 2) item.set_배율(((리틀버그베어[j].getRnd().nextInt(60) + 22) / 승률1_2));
                else item.set_배율(((리틀버그베어[j].getRnd().nextInt(55) + 12) / 승률1_2));
                break;
            case 3:
                if (대박 == 3) item.set_배율(((리틀버그베어[j].getRnd().nextInt(60) + 23) / 승률1_3));
                else item.set_배율(((리틀버그베어[j].getRnd().nextInt(55) + 13) / 승률1_3));
                break;
            case 4:
                if (대박 == 4) item.set_배율(((리틀버그베어[j].getRnd().nextInt(60) + 21) / 승률1_4));
                else item.set_배율(((리틀버그베어[j].getRnd().nextInt(55) + 11) / 승률1_4));
                break;
        }
    ...
    public void 레이스표가격변동(int id) {
        ...
        if (일등 == item.get_개이름()) {
            ...
            L1ShopItem item2 = new L1ShopItem(id, (int) (2 * 5000 * item.get_배율()), 1, 0);
    ...
    public void 상점초기화() {
        ...
        ShopTable.getInstance().delShop(70041);//퍼킨 id
    }
        ...
        public void run() {
            ...
            try {
                do {
                    ...
                    do {
                        if (찬스3 == 0 && count == 1) {
                            리틀버그베어[0].broadcastPacket(new S_AttackPacketForNpc(리틀버그베어[0], 리틀버그베어[0].getId(), 30));
                            sleep(3000);
                        }
        ...
        public void run() {
            ...
            try {
                do {
                    ...
                    do {
                        if (찬스3 == 1 && count == 1) {
                            리틀버그베어[1].broadcastPacket(new S_AttackPacketForNpc(리틀버그베어[1], 리틀버그베어[1].getId(), 30));
                            sleep(3000);
                        }
        ...
        public void run() {
            ...
            try {
                do {
                    ...
                    do {
                        if (찬스3 == 2 && count == 1) {
                            리틀버그베어[2].broadcastPacket(new S_AttackPacketForNpc(리틀버그베어[2], 리틀버그베어[2].getId(), 30));
                            sleep(3000);
                        }
        ...
        public void run() {
            ...
            try {
                do {
                    ...
                    do {
                        if (찬스3 == 3 && count == 1) {
                            리틀버그베어[3].broadcastPacket(new S_AttackPacketForNpc(리틀버그베어[3], 리틀버그베어[3].getId(), 30));
                            sleep(3000);
                        }
        ...
        public void run() {
            ...
            try {
                do {
                    ...
                    do {
                        if (찬스3 == 4 && count == 1) {
                            리틀버그베어[4].broadcastPacket(new S_AttackPacketForNpc(리틀버그베어[4], 리틀버그베어[4].getId(), 30));
                            sleep(3000);
                        }
