...
public class L1HouseLocation {
	...
	private static final Point[] TELEPORT_LOC_GIRAN = {
			new Point(33419, 32810), new Point(33343, 32723), // 창고, 애완동물 보관소
			new Point(33553, 32712), new Point(32702, 32842), }; // 속죄의 사자, 기란 시장

	private static final Point[] TELEPORT_LOC_HEINE = {
			new Point(33604, 33236), new Point(33649, 33413), // 창고, 애완동물 보관소
			new Point(33553, 32712), new Point(32702, 32842), }; // 속죄의 사자, 기란 시장

	private static final Point[] TELEPORT_LOC_ADEN = { new Point(33966, 33253),
			new Point(33921, 33177), // 창고, 애완동물 보관소
			new Point(33553, 32712), new Point(32702, 32842), }; // 속죄의 사자, 기란 시장

	private static final Point[] TELEPORT_LOC_GLUDIN = {
			new Point(32628, 32807), new Point(32623, 32729), // 창고, 애완동물 보관소
			new Point(33553, 32712), new Point(32702, 32842), }; // 속죄의 사자, 기란 시장
	...
	public static boolean isInHouseLoc(int houseId, int locx, int locy,
		...
		} else if (houseId == 262146) { // 기란아지트 2
			if (locx >= 33381 && locx <= 33387 && locy >= 32653
					&& locy <= 32656 && mapid == 4
					|| mapid == 5069) {
				ret = true;
			}
		} else if (houseId == 262147) { // 기란아지트 3
			if (locx >= 33392 && locx <= 33404 && locy >= 32650
					&& locy <= 32656 && mapid == 4
					|| mapid == 5070) {
				ret = true;
			}
		} else if (houseId == 262148) { // 기란아지트 4
			if (locx >= 33427 && locx <= 33430 && locy >= 32656
					&& locy <= 32662 && mapid == 4
					|| mapid == 5071) {
				ret = true;
			}
		} else if (houseId == 262149) { // 기란아지트 5
		...
		} else if (houseId == 262150) { // 기란아지트 6
			if (locx >= 33454 && locx <= 33466 && locy >= 32648
					&& locy <= 32654 && mapid == 4
					|| mapid == 5073) {
				ret = true;
			}
		} else if (houseId == 262151) { // 기란아지트 7
			if (locx >= 33476 && locx <= 33479 && locy >= 32665
					&& locy <= 32671 && mapid == 4
					|| mapid == 5074) {
				ret = true;
			}
		} else if (houseId == 262152) { // 기란아지트 8
		...
		} else if (houseId == 262153) { // 기란아지트 9
		...
		} else if (houseId == 262154) { // 기란아지트 10
			if (locx >= 33421 && locx <= 33433 && locy >= 32685
					&& locy <= 32691 && mapid == 4
					|| mapid == 5077) {
				ret = true;
			}
		} else if (houseId == 262155) { // 기란아지트 11
		...
		} else if (houseId == 262156) { // 기란아지트 12
		...
		} else if (houseId == 262157) { // 기란아지트 13
			if (locx >= 33372 && locx <= 33384 && locy >= 32692
					&& locy <= 32698 && mapid == 4
					|| mapid == 5080) {
				ret = true;
			}
		} else if (houseId == 262158) { // 기란아지트 14
			if (locx >= 33362 && locx <= 33365 && locy >= 32681
					&& locy <= 32687 && mapid == 4
					|| mapid == 5081) {
				ret = true;
			}
		} else if (houseId == 262159) { // 기란아지트 15
		...
		} else if (houseId == 262160) { // 기란아지트 16
		...
		} else if (houseId == 262161) { // 기란아지트 17
			if (locx >= 33345 && locx <= 33348 && locy >= 32672
					&& locy <= 32678 && mapid == 4
					|| mapid == 5084) {
				ret = true;
			}
		} else if (houseId == 262162) { // 기란아지트 18
			if (locx >= 33338 && locx <= 33350 && locy >= 32704
					&& locy <= 32711 && mapid == 4
					|| mapid == 5085) {
				ret = true;
			}
		} else if (houseId == 262163) { // 기란아지트 19
		...
		} else if (houseId == 262164) { // 기란아지트 20
		...
		} else if (houseId == 262165) { // 기란아지트 21
			if (locx >= 33380 && locx <= 33383 && locy >= 32712
					&& locy <= 32718 && mapid == 4
					|| mapid == 5088) {
				ret = true;
			}
		} else if (houseId == 262166) { // 기란아지트 22
			if (locx >= 33401 && locx <= 33413 && locy >= 32733
					&& locy <= 32739 && mapid == 4
					|| mapid == 5089) {
				ret = true;
			}
		} else if (houseId == 262167) { // 기란아지트 23
		...
		} else if (houseId == 262168) { // 기란아지트 24
			if (locx >= 33448 && locx <= 33451 && locy >= 32729
					&& locy <= 32735 && mapid == 4
					|| mapid == 5091) {
				ret = true;
			}
		} else if (houseId == 262169) { // 기란아지트 25
			if (locx >= 33404 && locx <= 33407 && locy >= 32754
					&& locy <= 32760 && mapid == 4
					|| mapid == 5092) {
				ret = true;
			}
		} else if (houseId == 262170) { // 기란아지트 26
			if (locx >= 33363 && locx <= 33375 && locy >= 32755
					&& locy <= 32761 && mapid == 4
					|| mapid == 5093) {
				ret = true;
			}
		} else if (houseId == 262171) { // 기란아지트 27
		...
		} else if (houseId == 262172) { // 기란아지트 28
			if (locx >= 33355 && locx <= 33361 && locy >= 32787
					&& locy <= 32790 && mapid == 4
					|| mapid == 5095) {
				ret = true;
			}
		} else if (houseId == 262173) { // 기란아지트 29
		...
		} else if (houseId == 262174) { // 기란아지트 30
			if (locx >= 33383 && locx <= 33386 && locy >= 32773
					&& locy <= 32779 && mapid == 4
					|| mapid == 5097) {
				ret = true;
			}
		} else if (houseId == 262175) { // 기란아지트 31
		...
		} else if (houseId == 262176) { // 기란아지트 32
		...
		} else if (houseId == 262177) { // 기란아지트 33
			if (locx >= 33498 && locx <= 33501 && locy >= 32801
					&& locy <= 32807 && mapid == 4
					|| mapid == 5100) {
				ret = true;
			}
		} else if (houseId == 262178) { // 기란아지트 34
			if (locx >= 33379 && locx <= 33385 && locy >= 32802
					&& locy <= 32805 && mapid == 4
					|| mapid == 5101) {
				ret = true;
			}
		} else if (houseId == 262179) { // 기란아지트 35
			if (locx >= 33373 && locx <= 33385 && locy >= 32822
					&& locy <= 32829 && mapid == 4
					|| mapid == 5102) {
				ret = true;
			}
		} else if (houseId == 262180) { // 기란아지트 36
			if (locx >= 33398 && locx <= 33401 && locy >= 32810
					&& locy <= 32816 && mapid == 4
					|| mapid == 5103) {
				ret = true;
			}
		} else if (houseId == 262181) { // 기란아지트 37
		...
		} else if (houseId == 262182) { // 기란아지트 38
		...
		} else if (houseId == 262183) { // 기란아지트 39
			if (locx >= 33456 && locx <= 33462 && locy >= 32838
					&& locy <= 32841 && mapid == 4
					|| mapid == 5106) {
				ret = true;
			}
		} else if (houseId == 262184) { // 기란아지트 40
		...
		} else if (houseId == 262185) { // 기란아지트 41
		...
		} else if (houseId == 262186) { // 기란아지트 42
			if (locx >= 33414 && locx <= 33417 && locy >= 32850
					&& locy <= 32856 && mapid == 4
					|| mapid == 5109) {
				ret = true;
			}
		} else if (houseId == 262187) { // 기란아지트 43
			if (locx >= 33372 && locx <= 33384 && locy >= 32867
					&& locy <= 32873 && mapid == 4
					|| mapid == 5110) {
				ret = true;
			}
		} else if (houseId == 262188) { // 기란아지트 44
			if (locx >= 33425 && locx <= 33437 && locy >= 32865
					&& locy <= 32871 && mapid == 4
					|| mapid == 5111) {
				ret = true;
			}
		} else if (houseId == 262189) { // 기란아지트 45
		...
		} else if (houseId == 327681) { // Heine 아지트 1
		...
		} else if (houseId == 327682) { // Heine 아지트 2
			if (locx >= 33627 && locx <= 33632 && locy >= 33206
					&& locy <= 33209 && mapid == 4
					|| mapid == 5114) {
				ret = true;
			}
		} else if (houseId == 327683) { // Heine 아지트 3
		...
		} else if (houseId == 327684) { // Heine 아지트 4
		...
		} else if (houseId == 327685) { // Heine 아지트 5
			if (locx >= 33616 && locx <= 33621 && locy >= 33262
					&& locy <= 33265 && mapid == 4
					|| mapid == 5117) {
				ret = true;
			}
		} else if (houseId == 327686) { // Heine 아지트 6
		...
		} else if (houseId == 327687) { // Heine 아지트 7
		...
		} else if (houseId == 327688) { // Heine 아지트 8
		...
		} else if (houseId == 327689) { // Heine 아지트 9
		...
		} else if (houseId == 327690) { // Heine 아지트 10
		...
		} else if (houseId == 327691) { // Heine 아지트 11
		...
		} else if (houseId == 524289) { // 그르딘아지트 1
			if (locx >= 32559 && locx <= 32566 && locy >= 32669
					&& locy <= 32676 && mapid == 4) {
				ret = true;
			}
		} else if (houseId == 524290) { // 그르딘아지트 2
		...
		} else if (houseId == 524291) { // 그르딘아지트 3
			if (locx >= 32537 && locx <= 32544 && locy >= 32781
					&& locy <= 32791 && mapid == 4) {
				ret = true;
			}
		} else if (houseId == 524292) { // 그르딘아지트 4
			if (locx >= 32550 && locx <= 32560 && locy >= 32780
					&& locy <= 32787 && mapid == 4) {
				ret = true;
			}
		} else if (houseId == 524293) { // 그르딘아지트 5
		...
		} else if (houseId == 524294) { // 그르딘아지트 6
	...
	public static int[] getHouseLoc(int houseId) { // houseId로부터 아지트의 좌표를 돌려준다
		int[] loc = new int[3];
		if (houseId == 262145) { // 기란아지트 1
			loc[0] = 33374;
			loc[1] = 32657;
	...
	public static int[] getBasementLoc(int houseId) { // houseId로부터 아지트의 지하실의 좌표를 돌려준다
		int[] loc = new int[3];
		if (houseId >= 262145 && houseId <= 262189) { // 기란아지트1~45
			loc[0] = 32780;
			loc[1] = 32815;
			loc[2] = houseId - 257077;
		} else if (houseId >= 327681 && houseId <= 327691) { // Heine 아지트1~11
			loc[0] = 32772;
			loc[1] = 32814;
			loc[2] = houseId - 322568;
		} else if (houseId >= 524289 && houseId <= 524294) { // 그르딘아지트1~6
			// 지하실이 없기 때문에, 아지트의 입구의 좌표를 돌려준다
	...
	public static int[] getHouseTeleportLoc(int houseId, int number) { // houseId로부터 텔레포트처의 좌표를 돌려준다
		int[] loc = new int[3];
		if (houseId >= 262145 && houseId <= 262189) { // 기란아지트
			loc[0] = TELEPORT_LOC_GIRAN[number].getX();
			loc[1] = TELEPORT_LOC_GIRAN[number].getY();
			loc[2] = TELEPORT_LOC_MAPID[number];
		} else if (houseId >= 327681 && houseId <= 327691) { // Heine 아지트
			loc[0] = TELEPORT_LOC_HEINE[number].getX();
			loc[1] = TELEPORT_LOC_HEINE[number].getY();
			loc[2] = TELEPORT_LOC_MAPID[number];
		} else if (houseId >= 458753 && houseId <= 458819) { // 에덴 아지트
