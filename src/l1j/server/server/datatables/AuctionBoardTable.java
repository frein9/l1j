...
import java.text.SimpleDateFormat; //## A18 AuctionBoardTable 오류 수정 위해 임포트 추가 
...
public class AuctionBoardTable {
    ...
    public void insertAuctionBoard(L1AuctionBoard board) {
        ...
        try {
            ...
            SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); //## A18 AuctionBoardTable 오류 수정 위해 변경
            String fm = formatter.format(board.getDeadline().getTime()); //#
//			String fm = DateFormat.getDateTimeInstance().format( //## A18 원본 
