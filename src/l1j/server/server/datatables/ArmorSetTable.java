...
public class ArmorSetTable {
    ...
    private void fillTable(ResultSet rs) throws SQLException {
        while (rs.next()) {
            ...
            as.setDmgup(rs.getInt("dmgModifier"));
            as.setHitup(rs.getInt("hitModifier"));
            as.setBowDmgModifier(rs.getInt("bowDmgModifier"));
            as.setBowHitRate(rs.getInt("bowHitRate"));
            as.setWeightReduction(rs.getInt("weightReduction"));
