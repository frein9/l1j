...
public class L1DatabaseFactory {
    ...
    /**
     * DB에의 액세스에 필요한 각 정보의 보존.
     *
     * @param driver   DB접속 드라이버
     * @param url      DB서버의 URL
     * @param user     DB서버에 접속하는 유저명
     * @param password DB서버에 접속하는 패스워드
     */
